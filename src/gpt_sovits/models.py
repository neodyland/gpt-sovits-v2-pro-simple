...
class CodePredictor(nn.Module):
    def __init__(
        ...
        self.ref_enc = MelStyleEncoder(ssl_dim, style_vector_dim=hidden_channels)
...
class SynthesizerTrnV3(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self.ref_enc = MelStyleEncoder(spec_channels, style_vector_dim=gin_channels)###Rollback
        self.ref_enc = MelStyleEncoder(704, style_vector_dim=gin_channels)  ###Rollback
